...
const ItemDisplay: React.FC<Props> = ({
  ...
  React.useEffect(() => {
    const loadItems = async () => {
      try {
        const data = await fetching(); // call the passed-in method
        setItems(data);
        console.log(data);
      } catch (error) {
    ...
    loadItems(); // ← you missed this call!
  }, [fetching]);
  ...
  return (
    ...
    >
      ...
      <Box
        sx={{ pl: "16px", display: "flex", justifyContent: "space-between" }}
      >
              ...
              >
                ...
                >
                  <Typography variant="body2">
                    {item.subItems === null ? 0 : item.subItems.length}
                  </Typography>
